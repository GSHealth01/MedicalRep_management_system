    ...
    tableData.forEach(doc => {
      doc.rows.forEach(row => {
        if (row.sampling && row.samplingQty) {
          total += parseInt(row.samplingQty) * 10;
        }
        if (row.stocking && row.stockingQty) {
          total += parseInt(row.stockingQty) * 25; 
        }
      });
    });
      ...
      {step === 1 && (
        <div style={{ maxWidth: '600px', margin: '0 auto' }}>
          <h2 style={{ 
            ...
            Step 1: RDaily Call Report
          </h2>

          <div style={{ marginBottom: '1rem' }}>
            <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500', color: '#34495e' }}>
              Date
            </label>
            <input 
              type="date" 
            ...
            >
              <div style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <span style={{ fontSize: '0.9rem', color: '#7f8c8d' }}>▾</span>
                </div>
              </div>
              {showDoctorDropdown && (
                <div style={{
                  ...
                  {doctors.map(doc => (
                    <label 
                      ...
                      style={{
                        ...
                        fontSize: '0.95rem',
                        background: selectedDoctors.includes(doc) ? '#e3f2fd' : 'transparent',
                        fontWeight: selectedDoctors.includes(doc) ? '500' : 'normal'
                      }}
                      onMouseEnter={e => {
            ...
            <table style={{
              ...
              <tbody>
                      ...
                      <td key={colIdx} style={{
                        ...
                        <div style={{
                          ...
                          <label style={{
                            ...
                            borderLeft: cell.sampling ? '3px solid #3498db' : 'none'
                          }}>
                            <span style={{ flex: 1, textAlign: 'left' }}>Sampling</span>
                            <input
                              type="checkbox"
                          ...
                          <label style={{
                            ...
                            borderLeft: cell.detailed ? '3px solid #3498db' : 'none'
                          }}>
                            <span style={{ flex: 1, textAlign: 'left' }}>Detailed</span>
                            <input
                              type="checkbox"
                          ...
                          <label style={{
                            ...
                            borderLeft: cell.stocking ? '3px solid #3498db' : 'none'
                          }}>
                            <span style={{ flex: 1, textAlign: 'left' }}>Stocking</span>
                            <input
                              type="checkbox"
                ...
                <tr style={{ background: '#f39c12', fontWeight: '600' }}>
                  <td colSpan={sampleProducts.length + 2} style={{
                    border: '1px solid #ecf0f1',
                    padding: '0.75rem',
                    textAlign: 'right',
                    color: 'white',
...
<table
  className="dcr-table expense-table"
  style={{
    marginTop: "2rem",
    width: "100%",
    maxWidth: "400px",
...
>
  ...
  <thead>
    <tr>
      <th style={{ textAlign: "left", padding: "0.75rem", borderBottom: "20px solid #ecf0f1" }}>
        Expense
      </th>
      <th style={{ textAlign: "left", padding: "0.75rem", borderBottom: "20px solid #ecf0f1" }}>
        Done
  ...
  <tbody>
    {[
      ...
      <tr key={item.key}>
        <td style={{ padding: "0.75rem", borderBottom: "20px solid #ecf0f1" }}>
          {item.label}
        </td>
        <td style={{ padding: "0.75rem", borderBottom: "20px solid #ecf0f1", textAlign: "left" }}>
          <input
            type="checkbox"
            checked={expenses[item.key]}
...
{/* REMARK SECTION WITH PROPER STYLING */}
<div style={{ 
  marginTop: '2rem', 
  marginBottom: '1rem',
  width: '100%',
